...
- [「飛鷹地產」後端開發的 Claude Code skill workflow](../eagle/skill-workflows.md)
...
> [`tradovate-new.sh`](scripts/tradovate-new.sh) + [`tradovate-signup.sh`](scripts/tradovate-signup.sh): 串接拋棄式信箱與兩支 API，全自動建立 Tradovate trial 練習帳號
>
